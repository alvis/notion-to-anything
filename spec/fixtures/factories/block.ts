 ...
 * @param paragraph the paragraph block content to use (icon defaults to null when omitted)
...
export function createParagraph<O extends BaseBlockOverrideOptions = {}>(
  paragraph: Omit<NotionBlock<'paragraph'>['paragraph'], 'icon'> &
    Partial<Pick<NotionBlock<'paragraph'>['paragraph'], 'icon'>>,
  override?: O,
...
export function createUnsupported(
  unsupported?: Partial<NotionBlock<'unsupported'>['unsupported']>,
  override?: BaseBlockOverrideOptions,
  ...
  return {
    type: 'unsupported',
    ...base,
    unsupported: { block_type: 'unsupported', ...unsupported },
  };
}
