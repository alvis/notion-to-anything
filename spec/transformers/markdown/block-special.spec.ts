...
describe('Special Handling Blocks', () => {
  ...
  describe('fn:tab', () => {
    it('should transform tab blocks to null', () => {
      const block = {
        ...defaultBlockProperties,
        id: 'tab-1',
        type: 'tab' as const,
      ...
      const result = tab(block);

      expect(result).toBeNull();
    });
  });

  describe('fn:meetingNotes', () => {
    it('should transform meeting notes blocks to null', () => {
      const block = {
        ...defaultBlockProperties,
        id: 'meeting-notes-1',
      ...
      const result = meetingNotes(block);
