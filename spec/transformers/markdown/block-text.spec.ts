...
describe('Text Content Blocks', () => {
  ...
  describe('fn:heading4', () => {
    it('should transform heading 4 with simple text', () => {
      const heading4Block = {
        ...defaultBlockProperties,
        id: 'heading4-1',
        ...
        has_children: false,
        heading_4: {
          rich_text: [createPlainText('Sub-subsection Title')],
          color: 'default',
          is_toggleable: false,
        },
        children: [],
      ...
      const result = heading4(heading4Block);
      expect(result).toBe('#### Sub-subsection Title');
    });
  });
  ...
  describe('fn:quote', () => {
    ...
    it('should transform quote with children', () => {
      const result = quote(
        createTransformedBlock(quoteWithChildren, [
          'Nested paragraph 1',
          'Nested paragraph 2',
        ]),
      );
  ...
  describe('fn:callout', () => {
    ...
    it('should transform callout with children', () => {
      const result = callout(
        createTransformedBlock(calloutWithChildren, [
          'Child content 1',
          'Child content 2',
        ]),
      );
