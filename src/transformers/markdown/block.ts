...
export const heading4: NotionBlockTransformer<string, 'heading_4'> = (block) =>
  `#### ${texts(block.heading_4.rich_text)}`;

export const tab: NotionBlockTransformer<string, 'tab'> = () => null;

export const meetingNotes: NotionBlockTransformer<
  string,
  'meeting_notes'
> = () => null;
